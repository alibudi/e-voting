...
<div class="px-content">
    <div class="page-header">
      <h1><i class="px-nav-icon ion-ios-paper"></i><span class="px-nav-label"></span>KELOLA DATA PEMILIH</h1>
    </div>

    <div class="row">
      <div class="col-sm-12">
        <div class="panel">
          <div class="panel-title">Data Pemilih</div>
          <small class="panel-subtitle text-muted">Kelola Data Pemilih</small>
          <div class="panel-body">
            <a class="btn btn-primary" href="../admin/add_calon.php"><i class="fa fa-plus"></i> Tambah Pemilih</a>
            <br><br>
