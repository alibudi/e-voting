...
<head>
  ...
  <!-- Theme -->
  <link href="../assets/css/themes/candy-cyan.min.css" rel="stylesheet" type="text/css">
  ...
  <div class="page-signin-modal modal">
    <div class="modal-dialog">
        ...
        <div class="box m-a-0">
          <div class="box-row">
            ...
            <div class="box-cell col-md-5 bg-primary p-a-4">
                <br/>
                <img src="../assets/img/logo.jpg" style="width:110px;height:100px;display:block;margin:auto;" alt="Logo">
                <br/>
                <div class="text-xs-center text-md-left">
                    <p class="text-center">
                        <span class="font-size-20 line-height-1">E-voting</span>
                    </p>
      ...
      <div class="text-xs-center m-t-2 font-size-14 text-black" id="px-demo-signup-link">
        Copyright &copy; 2018 E-voting. All rights reserved.
      </div>
    </div>
  </div>
